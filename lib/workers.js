...
var workers = {
                        ...
                        if (!err) {
                            ...
                            _logs.truncate(logId, function (err) {
                                if (!err) {
                                    ...
                                    console.log('Error truncting the logfile');
                                }
                            })
                        } else {
    ...
    'validateCheckData': function (originalCheckData) {
        ...
        if (originalCheckData.id &&
            ...
            console.log('Error: One of the checks is not properly formmated. Skipping it');
        }
    },
    ...
    'alertUserToStatusChange': function (newCheckData) {
        ...
        helpers.sendTwilioSms(newCheckData.userPhone, msg, function (err) {
            if (!err) {
                console.log('Success: User alerted to a status change in their check', msg);
            } else {
                console.log('Error: Counld not send SMS alert to user who had a state change to their check', msg);
            }
        });
    },
